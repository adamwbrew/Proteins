...
INSERT INTO Biotin(Biotin_Label)
    ...
    FROM master.dbo.proteins_identifiers_denormalized_3
...
INSERT INTO Mouse(Sample_Name, Biotin_ID, Virus_ID, Fraction_ID)
    SELECT DISTINCT 
        -- SUBSTRING(Sample_Name, 2, 4) AS Sample_Name,
        Sample_Name,
        B.Biotin_ID, 
        V.Virus_ID, 
        F.Fraction_ID
    FROM master.dbo.proteins_identifiers_denormalized_3 AS PI
...
INSERT INTO Protein_Id(Protein_Id_Label)
    ...
    FROM master.dbo.proteins_denormalized_3
...
INSERT INTO Protein(Protein_Name, Protein_Group, Protein_Id_ID, Gene_ID, Description_ID, Peptide_ID)
    SELECT DISTINCT 
        ...
        PD.Description_ID,
        PE.Peptide_ID
    FROM master.dbo.proteins_denormalized_3 AS P
...
INSERT INTO Mouse_Protein(Protein_ID, Mouse_ID, Hits)
    SELECT DISTINCT
        ...
        M.Mouse_ID, 
        MP.Hits
    FROM master.dbo.mouse_by_protein_3 AS MP
