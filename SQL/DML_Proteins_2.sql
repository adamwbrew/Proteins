...
INSERT INTO Biotin(Biotin_Label)
    ...
    FROM master.dbo.proteins_identifiers_denormalized_2
...
INSERT INTO Mouse(Sample_Name, Biotin_ID, Virus_ID, Fraction_ID)
    SELECT DISTINCT 
        ...
        V.Virus_ID, 
        F.Fraction_ID
    FROM master.dbo.proteins_identifiers_denormalized_2 AS PI
...
INSERT INTO Protein(Protein_Name, Protein_Group, Protein_Id_ID, Gene_ID, Description_ID, Peptide_ID)
    SELECT DISTINCT 
        ...
        PD.Description_ID,
        PE.Peptide_ID
    FROM master.dbo.proteins_denormalized_2 AS P
...
INSERT INTO Mouse_Protein(Protein_ID, Mouse_ID, Hits)
    SELECT DISTINCT
        ...
        M.Mouse_ID, 
        MP.Hits
    FROM master.dbo.mouse_by_protein_2 AS MP
